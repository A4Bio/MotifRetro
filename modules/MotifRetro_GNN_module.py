...
#         # self.motif_gate_sum = nn.Linear(input_dim, output_dim)
#         # self.num_embed = nn.Embedding(100, output_dim)
...
#     def forward(self, atom_feat, bond_feat, edge_idx, graph_id, sub_graph_ids=None, apply_activation: bool = True):
#         # atom_feat: [N, D]
#         # bond_feat: [E, D]
#         # edge_idx: [E, 2]
...
class MeganEncoder(nn.Module):
    ...
    def forward(self, x: dict) -> dict:
        ...
        for i, conv in enumerate(self.conv_layers):
            ...
            atom_feats, bond_feats = conv.forward(atom_feats, bond_feats, edge_idx, graph_id,apply_activation=not residual)
