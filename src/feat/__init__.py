...
# ORDERED_BOND_OH_KEYS = ['bond_type', 'bond_stereo', 'is_aromatic', 'is_edited']
ORDERED_BOND_OH_KEYS = ['bond_type', 'bond_stereo', 'is_edited']

# # all possible motif features
# ORDERED_MOTIF_OH_KEYS = ['is_supernode', 'motif_ids']  # TODO: add this two features , 'is_edited', 'is_reactant']
