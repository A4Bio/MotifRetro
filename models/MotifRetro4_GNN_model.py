...
from modules.MotifRetro4_GNN_module import MeganDecoder
from modules.MotifRetro4_GNN_module import MeganEncoder
import numpy as np
import random
import time
...
class Megan(nn.Module):
    def __init__(self, 
                 ...
                 use_past_values: bool = False,
                 use_degree_feat: bool = False,
                 use_synthon_feat: bool = False,
        ...
        self.use_past_values = use_past_values
        self.use_degree_feat = use_degree_feat
        self.use_synthon_feat = use_synthon_feat
        ...
        if self.use_synthon_feat:
            self.synthon_embedding = nn.Embedding(10, hidden_dim)
    ...
    def forward_step_sparse(self, step_batch: dict, state_dict=Optional[dict],
        ...
        if self.use_past_values and state_dict is not None:
